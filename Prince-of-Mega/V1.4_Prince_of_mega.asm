...
funx:	
	...
	addi $8, $0, 13 # Valor do pulo do skullman
	sw $8, 20($15)
...
movelef:	addi $20, $20, -4
		addi $8, $8, -1
		sw $8, 804($15)
		j skugnore
		
voltjump:	sw $0, 808($15)



skugnore:	add $31, $0, $22
	jr $31		
#=======================================
#	FUNCAO MEGATIRO
megatiro:	
...
selfdamage:	
	...
	sw $9, 16($15)
	jal atakverif #Reseta o código de pulo do skullman
...
persia3:	
	...
	addi $4, $0, 15 #coloca o tempo da pausa no reg 4 	lw $13, 0($23) 	 	bne $13, $0, dim 	j persiac:
	sw $4, 200($15) #quando usa o 32 no reg2 usa o jr $31 da pausa
	jr $31
...
persia6:	addi $4, $0, 38 #D2
	...
	addi $4, $0, 12 #coloca o tempo da pausa no reg 4 	lw $13, 0($23) 	 	bne $13, $0, dim 	j persiac:
	sw $4, 200($15) #quando usa o 32 no reg2 usa o jr $31 da pausa
	jr $31
...
persia7:	addi $4, $0, 37 #C#2
	...
	addi $4, $0, 60 #coloca o tempo da pausa no reg 4 	lw $13, 0($23) 	 	bne $13, $0, dim 	j persiac:
	sw $4, 200($15) #quando usa o 32 no reg2 usa o jr $31 da pausa
	jr $31
...
persia10:	addi $4, $0, 49 #C#3
	...
	addi $4, $0, 100 #coloca o tempo da pausa no reg 4 	lw $13, 0($23) 	 	bne $13, $0, dim 	j persiac:
	sw $4, 200($15) #quando usa o 32 no reg2 usa o jr $31 da pausa
	jr $31
...
persia12:	addi $4, $0, 58 #F#3
	...
	addi $4, $0, 10 #coloca o tempo da pausa no reg 4 	lw $13, 0($23) 	 	bne $13, $0, dim 	j persiac:
	sw $4, 200($15) #quando usa o 32 no reg2 usa o jr $31 da pausa
	jr $31
...
persia14:	addi $4, $0, 54 #F#3
	...
	addi $4, $0, 150 #coloca o tempo da pausa no reg 4 	lw $13, 0($23) 	 	bne $13, $0, dim 	j persiac:
	sw $4, 200($15) #quando usa o 32 no reg2 usa o jr $31 da pausa
	jr $31
...
persia15:	addi $4, $0, 61 #C#4
	...
	addi $4, $0, 20 #coloca o tempo da pausa no reg 4 	lw $13, 0($23) 	 	bne $13, $0, dim 	j persiac:
	sw $4, 200($15) #quando usa o 32 no reg2 usa o jr $31 da pausa
	jr $31
...
persia16:	addi $4, $0, 59 #B3
	...
	addi $4, $0, 90 #coloca o tempo da pausa no reg 4 	lw $13, 0($23) 	 	bne $13, $0, dim 	j persiac:
	sw $4, 200($15) #quando usa o 32 no reg2 usa o jr $31 da pausa
	jr $31
...
persia20:	addi $4, $0, 59 #B3
	...
	addi $4, $0, 157 #coloca o tempo da pausa no reg 4 	lw $13, 0($23) 	 	bne $13, $0, dim 	j persiac:
	sw $4, 200($15) #quando usa o 32 no reg2 usa o jr $31 da pausa
	jr $31
...
persia21:	addi $4, $0, 54 #B3
	...
	addi $4, $0, 120 #coloca o tempo da pausa no reg 4 	lw $13, 0($23) 	 	bne $13, $0, dim 	j persiac:
	sw $4, 200($15) #quando usa o 32 no reg2 usa o jr $31 da pausa
	jr $31
...
persia29:	addi $4, $0, 54 #D3
	...
	addi $4, $0, 50 #coloca o tempo da pausa no reg 4 	lw $13, 0($23) 	 	bne $13, $0, dim 	j persiac:
	sw $4, 200($15) #quando usa o 32 no reg2 usa o jr $31 da pausa
	jr $31
...
persia45:	addi $4, $0, 38 #D3
	...
	addi $4, $0, 40 #coloca o tempo da pausa no reg 4 	lw $13, 0($23) 	 	bne $13, $0, dim 	j persiac:
	sw $4, 200($15) #quando usa o 32 no reg2 usa o jr $31 da pausa
	jr $31
...
persia81:	addi $4, $0, 57 #B2
	...
	addi $4, $0, 110 #coloca o tempo da pausa no reg 4 	lw $13, 0($23) 	 	bne $13, $0, dim 	j persiac:
	sw $4, 200($15) #quando usa o 32 no reg2 usa o jr $31 da pausa
	jr $31
...
atakverif:	add $19, $0, $31
	...
	lw $8, 192($15) #Carrega da memoria o valor de pulos
	sw $8, 184($15) #Salva na memoria o valor do contador
